...
Server::Server(Config * new_client_information):token({0}), updated(0)
{
//    char buf[80];
...
bool Server::InitializeCommunication(void)
{
	...
	GNOMEDATA **genome_data = new GNOMEDATA*[this->client_information->GetClientNumber()];
