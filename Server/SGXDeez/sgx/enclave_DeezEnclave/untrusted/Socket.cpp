...
//#pragma  comment(lib,"openssl-0.9.8k/lib/libssl.a")
#endif
...
{
//	printf("close socket with ss is %d\n", SS);
	if (SSLenable)
	{
...
#else
  if(SS>=0) {
//	  printf("close socket without ss, but ss is %d\n", SS);
	  close(SS);
	  SS=-1;
//	  printf("close socket end\n");
  }
#endif
}
