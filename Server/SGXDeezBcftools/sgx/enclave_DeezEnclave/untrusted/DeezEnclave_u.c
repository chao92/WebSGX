...
static sgx_status_t SGX_CDECL DeezEnclave_ocall_bcfenclave_sample(void* pms)
{
...
static sgx_status_t SGX_CDECL DeezEnclave_ocall_hfile_oflags(void* pms)
{
...
static sgx_status_t SGX_CDECL DeezEnclave_ocall_open(void* pms)
{
...
static sgx_status_t SGX_CDECL DeezEnclave_ocall_read(void* pms)
{
...
static sgx_status_t SGX_CDECL DeezEnclave_ocall_write(void* pms)
{
...
static sgx_status_t SGX_CDECL DeezEnclave_ocall_close(void* pms)
{
...
static sgx_status_t SGX_CDECL DeezEnclave_ocall_fsync(void* pms)
{
...
static const struct {
	...
	23,
	{
		...
		(void*)DeezEnclave_ocall_bcfenclave_sample,
		(void*)DeezEnclave_ocall_hfile_oflags,
		(void*)DeezEnclave_ocall_open,
		(void*)DeezEnclave_ocall_read,
		(void*)DeezEnclave_ocall_write,
		(void*)DeezEnclave_ocall_close,
		(void*)DeezEnclave_ocall_fsync,
