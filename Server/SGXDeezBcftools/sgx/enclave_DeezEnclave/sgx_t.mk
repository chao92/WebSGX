...
DeezEnclave_C_Files := $(wildcard $(TRUSTED_DIR)/*.c)
...
Flags_Just_For_C := -Wno-implicit-function-declaration -std=c11 -nostdinc -fno-builtin-sprintf
...
DeezEnclave_Cpp_Flags :=  $(Common_C_Cpp_Flags) -std=c++11 -nostdinc++ -fno-builtin-printf -fno-builtin-sprintf -I.
